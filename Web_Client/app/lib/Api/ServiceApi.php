...
class ServiceApi
{
     ...
     *
     * @param \Swagger\Client\Model\Service $body  (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\TransportTask[]
     */
    public function serviceGet($body)
    {
        list($response) = $this->serviceGetWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function serviceGetWithHttpInfo($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling serviceGet');
        }
        // parse inputs
